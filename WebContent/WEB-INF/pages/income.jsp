...
<script type="text/javascript">
	...
	function res(data, status) {
		if (status == "success") {
			...
			col = document.createElement("th");
			col.appendChild(document.createTextNode("收入类型"));
			row.appendChild(col);
	...
	<div style="margin-left:200px">
		<div style="width: 660px; background-color: #ffffff">
			...
			<div style="margin-left: 200px; width: 300px">
				<h3>收入记账</h3>
				<form action="addIncome" method="get" id="form1">
					<table>
						<tr>
							<td>日期：</td>
						...
						<tr>
							<td>收入类型:</td>
							<td><input type="text" name="type" id="input2"
								class="form-control"></td>
						</tr>
						<tr>
							<td>金额:</td>
							<td><input type="text" name="money" id="input3"
								class="form-control"></td>
						</tr>
						<tr>
						...
						<tr>
							<td>备注：</td>
							<td><input type="text" name="remake" id="input4"
								class="form-control"></td>
						</tr>
						<tr>
							<td>处理人员</td>
							<td><input type="text" name="name" id="input5"
								class="form-control"></td>
						</tr>
					</table>
